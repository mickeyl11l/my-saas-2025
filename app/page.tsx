  ...
  return (
    <>
      ...
      <MS className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-purple-800/40 via-transparent to-transparent animate-pulse" />
      ...
      <section className="py-32 relative">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-10 max-w-7xl mx-auto">
            {[
              { icon: Zap, title: "3D Космический Hero", desc: "Вау-эффект с первых 3 секунд" },
              { icon: Shield, title:title "Glassmorphism UI", desc: "Выглядит дорого и современно" },
              { icon: Rocket, title: "Конфетти при клике", desc: "Эмоция = покупка" },
              { icon: Users, title: "Готов к командам", desc: "Приглашения, роли, биллинг" },
              { icon: Star, title: "Анимации Framer Motion", desc: "Плавно как в премиум-приложениях" },
      ...
      <section className="py-32 bg-black/70">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-5xl font-bold mb-12 text-white">Один платёж. Вечная магия.</h2>
          <div className="glass rounded-3xl p-16 max-w-2xl mx-auto shadow-2xl border border-white/20">
            ...
            <p className="text-2xl text-gray-300 mb-12">Разовый платёж • Полный код • Обновления навсегда</p>
